...
#line 971 "RealPPPort.xs"
                dTARG;
#line 1793 "RealPPPort.c"
#line 973 "RealPPPort.xs"
                TARG = sv_newmortal();
                EXTEND(SP, 1);
                PUSHu(42);
                XSRETURN(1);
#line 1799 "RealPPPort.c"
	PUTBACK;
	return;
    }
}
...
XS_EUPXS(XS_Devel__PPPort_CopFILE)
{
	...
	char *	RETVAL;
	dXSTARG;
#line 1529 "RealPPPort.xs"
                RETVAL = CopFILE(PL_curcop);
#line 2903 "RealPPPort.c"
	sv_setpv(TARG, RETVAL); XSprePUSH; PUSHTARG;
    }
    XSRETURN(1);
}
...
;
	SV *	sv2 = ST(1)
;
#line 2120 "RealPPPort.xs"
                char *str;
                STRLEN len;
#line 4030 "RealPPPort.c"

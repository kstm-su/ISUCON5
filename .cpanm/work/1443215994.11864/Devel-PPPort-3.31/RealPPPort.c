...
#line 4289 "RealPPPort.c"
	UV	RETVAL;
	dXSTARG;
#line 2229 "RealPPPort.xs"
                pv = SvPV(string, len);
                if (!grok_number(pv, len, &RETVAL))
                  XSRETURN_UNDEF;
#line 4296 "RealPPPort.c"
	XSprePUSH; PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
}

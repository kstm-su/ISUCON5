...
"x86_64-linux-3.19.0-21-generic" or
	die "Errno architecture (x86_64-linux-3.19.0-21-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
